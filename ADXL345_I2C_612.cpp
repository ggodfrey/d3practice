...
const uint8_t ADXL345_I2C_612::kAddress;
const uint8_t ADXL345_I2C_612::kPowerCtlRegister;
const uint8_t ADXL345_I2C_612::kDataFormatRegister;
const uint8_t ADXL345_I2C_612::kDataRegister;
constexpr double ADXL345_I2C_612::kGsPerLSB;
 ...
 */
ADXL345_I2C_612::ADXL345_I2C_612(uint8_t moduleNumber, ADXL345_I2C_612::DataFormat_Range range)
	: m_i2c (NULL)
{
 ...
 * Destructor.
 */
ADXL345_I2C_612::~ADXL345_I2C_612()
{
	delete m_i2c;
	m_i2c = NULL;
}
 ...
 */
double ADXL345_I2C_612::GetAcceleration(ADXL345_I2C_612::Axes axis)
{
        // Turn on the measurements
        m_i2c->Write(kPowerCtlRegister, kPowerCtl_Measure);
        // Specify the data format to read
 ...
 */
ADXL345_I2C_612::AllAxes ADXL345_I2C_612::GetAccelerations()
{
        // Turn on the measurements
        m_i2c->Write(kPowerCtlRegister, kPowerCtl_Measure);
        // Specify the data format to read
